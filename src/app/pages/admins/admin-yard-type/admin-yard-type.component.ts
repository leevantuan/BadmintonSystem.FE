...
@Component({
  selector: 'app-admin-yard-type',
  imports: [AdminTableComponent, CommonModule, FormsModule],
  templateUrl: './admin-yard-type.component.html',
  styleUrl: './admin-yard-type.component.css',
})
export class AdminYardTypeComponent {
